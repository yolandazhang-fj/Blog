...
Under The "all" mark, we set “VariableSelected” to detail variable and set the value used to be attribute and under the “measure values”mark, we set the graph pattern to line and measure values as the path variable. 
