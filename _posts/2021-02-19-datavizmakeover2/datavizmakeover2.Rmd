...
library(dplyr)
library(kableExtra)
kable(clarity,type='html',align='c',out.width="100%") %>%
  row_spec(0, color = 'white', background = 'black', align='c') %>% #format header color and background. 
...
library(dplyr)
library(kableExtra)
kable(aesthetic,type='html',align='c') %>%
  row_spec(0, color = 'white', background = 'black', align='c') %>% #format header color and background. 
  column_spec(1:2, width_min="2em") %>%
  row_spec(1:5, extra_css = "border-bottom: 1px solid")
```
...
library(dplyr)
library(kableExtra)
kable(clarity,type='html',align='c') %>%
  row_spec(0, color = 'white', background = 'black', align='c') %>% #format header color and background. 
